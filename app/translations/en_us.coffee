module.exports =
  ...
  tutorial:
    welcome:
      ...
      details_stage2: "Gravitational Lenses are very rare astronomical objects. On Tuesday night, we found a few thousand candidates. Now we are trying to refine this sample to identify the really convincing ones, and we need your help!"
    what_are_lenses_1:
    ...
    thanks:
      ...
      details_stage2: "Remember: lensed galaxies are rare, and difficult to spot: relatively few of the images you will see will contain a gravitational lens, and you may need to look quite carefully to see the lensed features! Take your time.<br/><br/>Over your first few classifications we'll give you a few more tips and access to some different tools to help you as you search for these rare objects.<br/><br/>Click 'Finished marking!' to continue."
    talk:
      header: "Talk"
  ...
  about:
    ...
    ludo_bio: "Ludovic is professor of physics and astronomy at the University of British Columbia in Vancouver. He started as an amateur astronomer at the age of 10 and he never stopped sharing his passion for night sky observing with the public since then. He studied theoretical physics in Paris and specialised in astrophysics for his PhD. He lead the scientific analysis of one of the teams that discovered gravitational lensing by large scale structures in 2000. His research has since focused on the use of gravitational lensing to map dark matter in combination with other cosmological probes in order to explore a large variety of cosmological models. The CFHT Stripe 82 survey is one of the surveys he is currently coordinating."
